...
include '../koneksi.php';
  ...
  if(isset($_POST["login"])){
    ...
    if ($level == 'Admin') {
      ...
      $login = mysqli_query($koneksi, "SELECT * FROM pendaftaran WHERE username = '$username' OR email = '$email' AND password = '$password' AND level = '$level'");
          $cek = mysqli_num_rows($login);
        ...
        $login = mysqli_query($koneksi, "SELECT * FROM instruktur WHERE username = '$username' AND password = '$password' AND level = '$level'");
                $cek = mysqli_num_rows($login);
