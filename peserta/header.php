                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <center><img src="foto/<?php echo $data['foto'] ?>" style="width: 100px; height: 180px"><br>
                            <p style="color: white; font-size: 20px; font-family: Calibri"><b>Peserta</b></p></center><br>
                        	<li class="active">
                            ...
                            <li>
                                <a href="pendaftaran"><i class="ti-pin2"></i> <span>Pendaftaran</span></a>
                            </li>
                            <li>
                                <a href="kontak"><i class="fa fa-phone"></i> <span>Kontak Admin</span></a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            <img class="avatar user-thumb" src="foto/<?php echo $data['foto'] ?>" alt="avatar">
