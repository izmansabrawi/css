...
$query = mysqli_query($koneksi, "INSERT INTO pendaftaran VALUES(NULL, '$nama', '$username', '$password', '$email', '$tempat', '$tanggal', '$jk', '$agama', '$pendidikan', '$alamat', '$provinsi', '$kota', '$kecamatan', '$desa', '$status', '$newfilename', 'Peserta')");
